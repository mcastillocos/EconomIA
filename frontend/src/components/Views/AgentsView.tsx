...
export function AgentsView() {
  ...
  const agents: AgentDef[] = [
    ...
    { name: 'DailyNewsAgent', status: 'planned', description: 'Briefing diario de noticias relevantes' },
    ...
    { name: 'ScreenerAgent', status: 'planned', description: 'Screening inteligente con IA' },
    { name: 'PortfolioBriefingAgent', status: 'planned', description: 'Resumen de cartera' },
